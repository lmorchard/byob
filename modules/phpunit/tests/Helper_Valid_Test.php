...
class Helper_Valid_Test extends PHPUnit_Framework_TestCase
{
	...
	{
		return array(array('2', array(1,3), TRUE),
		             array('2', array(3,4), FALSE),
		             array('a', array(1,3), FALSE),
		             array('2', array(1), TRUE),
		             array('2', array(3), FALSE),
		             array('a', array(1), FALSE));
	}
	 ...
	 * @test
	 */
	public function range($input_number, $input_range, $expected_result)
	{
	...
	{
		return array(array('abc',                 TRUE),
                     array('ab1',                 TRUE),
                     array('abc123',              TRUE),
		             array('abx120',              FALSE),
		             array('this is not a color', FALSE));
	}
