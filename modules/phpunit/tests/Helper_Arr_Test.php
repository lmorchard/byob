...
class Helper_Arr_Test extends PHPUnit_Framework_TestCase
{
	...
	/**
	 * DataProvider for the arr::get() test
	 */
	public function get_provider()
	{
		return array(
			array(array('A'), 0, 'Z', 'A'),
			array(array('A'), 1, 'Z', 'Z'),
			array(array('a' => 'A'), 'a', 'Z', 'A'),
			array(array('a' => 'A'), 'b', 'Z', 'Z'),
		);
	}

	/**
	 * Tests the arr::get() function.
	 * @dataProvider get_provider
	 * @group core.helpers.arr.get
	 * @test
	 */
	public function get($input_array, $input_key, $input_default, $expected_result)
	{
		$result = arr::get($input_array, $input_key, $input_default);
