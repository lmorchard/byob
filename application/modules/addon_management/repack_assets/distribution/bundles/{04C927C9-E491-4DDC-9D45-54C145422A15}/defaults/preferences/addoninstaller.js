...
// flag to show the loading dialog.
pref("extensions.addoninstaller.show.loadingDialog", true);
// flag to show the selection dialog.
pref("extensions.addoninstaller.show.selectionDialog", true);
