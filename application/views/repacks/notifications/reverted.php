...
The current release for browser <?=$repack->display_title?> has been removed at 
your request. This browser is no longer available for download. If you want to 
re-release this version of the browser, you must re-submit it for release.
